...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/mjimenez/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/mjimenez/.config/xmobar/xmobarrc0"
...
myKeys = [
      ...
      -- Applications
          ...
          ("M-n", spawn "alacritty -e ranger ~"),
          ("M-S-p", spawn "dmenu_run -fn 'FiraCode Nerd Font:size=10' -nb '#292d3e' -nf '#bbc5ff' -sb '#82AAFF' -sf '#292d3e' -p 'dmenu:'")
          ]
--
--    -- Windows navigation
...
--        , ("M-S-<Return>", spawn "dmenu_run -fn 'FiraCode Nerd Font:size=10' -nb '#292d3e' -nf '#bbc5ff' -sb '#82AAFF' -sf '#292d3e' -p 'dmenu:'")
...
myWorkspaces = clickable . (map xmobarEscape) 
               $ ["1:dev", "2:www", "3:sys", "4:virt", "5:comm", "6:media", "7:gfx", "8:stream"]
  where                                                                      
...
myManageHook = composeAll
     [
        className =? "Google-chrome"        --> doShift "<action=xdotool key super+2>2:www</action>"
      , className =? "Picture-in-picture"   --> doShift "<action=xdotool key super+2>6:media</action>"
      , className =? "obs"                  --> doShift "<action=xdotool key super+2>8:stream</action>"
      , className =? "Alacritty"            --> doShift "<action=xdotool key super+2>1:dev</action>"
      --, title =? "Chrome"                   --> doShift "<action=xdotool key super+2>2:www</action>"
